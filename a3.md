...
1. Clearly state which project you are reviewing _(i.e., project name and group members --- consult the [Final Project Schedule]({{ site.baseurl }}/project/schedule))_.
