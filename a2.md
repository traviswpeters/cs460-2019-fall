...
| ---------------------------------------------------------------------------- | ------- |------ |
| You have an on-time assignment written in C reflecting good-faith effort     | 20      |       |
| The code shows good software engineering principles                          | 10      |       |
| The submission demonstrated good testing                                     | 10      |       |
| The simulation parameters were setup according to the assignment spec        | 20      |       |
| The submission correctly implements FIFO, SJF, and SRT (10pts each)          | 30      |       |
| The submission showed a meaningful performance comparison via plots          | 10      |       |
| ---------------------------------------------------------------------------- | ------- |------ |
| **Total**                                                                    | **100** |       |
| ---------------------------------------------------------------------------- | ------- |------ |
