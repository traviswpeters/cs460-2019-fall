...
The simulation maintains the current time, $$t$$, which is initialized to 0 and is incremented after each simulation step.
...
- The values $$d$$ and $$v$$ should be selected relative to $$k$$. The value $$k$$/$$n$$ represents the frequency of process arrivals.
...
3. A `README.md` file (written in Markdown), which provides a summary of the program and your approach to building this program.
